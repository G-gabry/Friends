    ...
    <>
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-foreground text-background">
              ...
              <CardContent className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  <span>سعر القطع</span>
                  <span className="px-2">{tieredTotal.toLocaleString()} EGP</span>
                </div>
                <div className="flex justify-between">
                  <span>مصاريف الشحن</span>
                  {shippingCost > 0 ? (
                    <span className="px-2 font-bold text-blue-300">{shippingCost.toLocaleString()} EGP</span>
                  ) : (
                    <span className="px-2 text-muted-foreground/70">مشمولة ضمن الإجمالي</span>
                  )}
                </div>
      ...
      {printConfig && (
        <div className="hidden print:block w-full bg-white text-black" dir="rtl">
          {printConfig === 'invoice' && (
            <InvoicePrint order={findOrder} orderItems={findOrderItems} profilesMap={profilesMap} shippingCost={shippingCost} />
          )}
          {printConfig === 'sticker' && (
